...
// 	if($_GET['part'] == 'n')	//北校入口
// 	{
// 		$insert = $db -> exec("insert into step (id,wechat_id,part,chance,score,time) values ('','$wechat_id','n','3','0',NOW())");
// 	}else	//南校入口
// 	{
// 		$insert = $db -> exec("insert into step (id,wechat_id,part,chance,score,time) values ('','$wechat_id','s','3','0',NOW())");
// 	}
// 	$db -> commit();
// }
// catch(Exception $e)
...
// $chance = $rs->fetch();
//
// while(($score['score'] <= 12) && ($chance['chance'] > 0))	//不大于12个答题点且答题机会大于0
// {
